...
- 지금은 **세 축이 모두 있는 가장 최근 기록**으로 그리고, 그것이 최신이 아니면 위에 한 줄로 밝힌다
- 셋 다 갖춘 기록이 없으면 **무엇이 빠졌는지**(체중·골격근량·체지방률 중)와 키·성별을 채우면
  범위를 계산할 수 있다는 안내를 보여 준다 (`components/BodyRadar.tsx`)
